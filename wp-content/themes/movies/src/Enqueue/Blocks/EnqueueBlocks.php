 ...
 *
 * @package Movies\Enqueue\Blocks
 */

declare(strict_types=1);

namespace Movies\Enqueue\Blocks;

use Movies\Config\Config;
use MoviesVendor\EightshiftLibs\Manifest\ManifestInterface;
use MoviesVendor\EightshiftLibs\Enqueue\Blocks\AbstractEnqueueBlocks;
