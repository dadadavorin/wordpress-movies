...
export const HeadingOptions = (attributes) => {
	...
	const headingLevels = [
		{ label: 'H1', tooltip: __('Heading 1', 'Movies'), value: 1 },
		{ label: 'H2', tooltip: __('Heading 2', 'Movies'), value: 2 },
		{ label: 'H3', tooltip: __('Heading 3', 'Movies'), value: 3 },
		{ label: 'H4', tooltip: __('Heading 4', 'Movies'), value: 4 },
		{ label: 'H5', tooltip: __('Heading 5', 'Movies'), value: 5 },
		{ label: 'H6', tooltip: __('Heading 6', 'Movies'), value: 6 },
	];
	...
	return (
		<UseToggle {...generateUseToggleConfig(attributes, manifest, 'headingUse')}>
			...
			>
				{!hideColor &&
					<ColorPicker
						label={(!hideSize && !hideFontWeight) ? null : <IconLabel icon={icons.color} label={__('Color', 'Movies')} />}
				...
				{!hideHeadingLevel &&
					<Menu
						...
						tooltip={__('Heading level', 'Movies')}
